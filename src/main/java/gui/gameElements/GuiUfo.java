...
/**
 * This class manually defines the shape of an enemy UFO. It further rotates and moves this values
 * to fit the object the shape shall represent.
 */
public class GuiUfo extends GuiObject {
  ...
  /**
   * This constructor takes an UFO Object and re-calculates the hard coded array into the position
   * on screen.
   *
   * @param ufo
   */
